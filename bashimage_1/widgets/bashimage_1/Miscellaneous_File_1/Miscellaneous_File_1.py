...
class OWMiscellaneous_File_1(OWBwBWidget):
    ...
    map_ap=pset("/data/exomiser-cli-13.2.0/examples")
    map_dockerfilez=pset("/data/bashimage_1/widgets/bashimage_1/Miscellaneous_File_1/Dockerfiles")
    vcfname=pset("Pfeiffer.vcf")
    ymlname=pset("test-analysis-exome.yml")
    def __init__(self):
